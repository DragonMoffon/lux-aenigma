...
class SceneView(LuxView):
    ...
    def __init__(self, back: LuxView):
        ...
        self.beam = BeamLightRay(
            ...
            250.0,
            LuxColour.WHITE(),
            Ray(Vec2(w, h + 150.0), Direction.EAST(), 2500.0, LuxColour.WHITE()),
            Ray(Vec2(w, h - 150.0), Direction.EAST(), 2500.0, LuxColour.WHITE())
        )

        self.filter_red = FilterRayInteractor(Vec2(w+125, h+200), Direction.WEST(), LuxColour.RED(), (RayInteractorEdge(Vec2(0.0, -50.0), Vec2(0.0, 50.0), True),))
        self.filter_green = FilterRayInteractor(Vec2(w+400, h+250), Direction.NORTHEAST(), LuxColour.GREEN(), (RayInteractorEdge(Vec2(0.0, -50.0), Vec2(0.0, 50.0), True),))
        self.filter_blue = FilterRayInteractor(Vec2(w+200, h+125), Direction.SOUTHWEST(), LuxColour.BLUE(), (RayInteractorEdge(Vec2(0.0, -50.0), Vec2(0.0, 50.0), True),))
        self.filter_cyan = FilterRayInteractor(Vec2(w+200, h+225), Direction.SOUTHWEST(), LuxColour.CYAN(), (RayInteractorEdge(Vec2(0.0, -50.0), Vec2(0.0, 50.0), False),))
        ...
        self.beam.propagate_ray(self.edge_map)
