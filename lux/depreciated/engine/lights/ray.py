...
class Ray(NamedTuple):
    ...
    def calculate_ray_interaction(self, interactors: tuple[RayInteractor, ...]) -> tuple[Vec2, RayInteractorEdge, RayInteractor] | None:
        intersecting_edges = []

        ray_start = self.source
        ray_end = ray_start + self.direction * self.length
